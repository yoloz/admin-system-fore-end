...
const handleCommand = (command: string) => {
    switch (command) {
        case 'auth':
            ...
            break
        case 'del':
            ElMessageBox.confirm('确认要删除吗? 删除后将无法恢复!', '警告', {
      ...
      >
        ...
        <template #dropdown>
          <el-dropdown-menu>
            ...
            <el-dropdown-item v-show="!rawRow?.builtin" command="del">删除</el-dropdown-item>
          </el-dropdown-menu>
        </template>
      </el-dropdown>
    </template>
      ...
      <div class="drawer-body-infor">
        ...
        <li class="list-item">
          ...
          <p class="value">
            {{
              rawRow?.createTime
                ? dayjs(rawRow?.createTime).format("YYYY-MM-DD HH:mm:ss")
                : ""
            }}
          </p>
        </li>
        ...
        <li class="list-item">
          ...
          <p class="value">
            {{
              rawRow?.updateTime
                ? dayjs(rawRow?.updateTime).format("YYYY-MM-DD HH:mm:ss")
                : ""
            }}
          </p>
        </li>
