...
import { getErrorLogList, exportLog, getException } from './service/logSercices'
...
<template>
  <custom-table-layout>
    ...
    <template #table>
      <custom-table ref="tableListRef" model="api" :api="getErrorLogList" :params="params"
        ...
        <el-table-column label="异常详情" width="100" fixed="right">
          <template #default="scope">
            <el-button link type="primary" @click="getErrorMsg(scope.row.id)">查看详情</el-button>
          </template>
        </el-table-column>
