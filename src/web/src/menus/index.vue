...
<template>
    <custom-table-layout>
        <template #header>
            <custom-header-layout>
                ...
                <template #right>
                    <el-button type="primary" @click="addMenu" style="margin-right: 10px">添加菜单</el-button>
                    <el-dropdown @command="handleDropDown">
                        ...
                        <template #dropdown>
                            <el-dropdown-menu>
                                <el-upload ref="uploadRef" class="upload-demo" accept=".xlsx" :file-list="file"
                                    :show-file-list="false" :http-request="httpRequest" action="none">
    ...
    <create-menu-dialog ref="createMenuRef" @update-table="refreshTable"></create-menu-dialog>
</template>
